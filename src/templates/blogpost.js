...
const Article = ({ data }) => {
  ...
  return (
    ...
    <div className="mt-5 mx-auto ml-8 mr-8 border-l-2 border-blue-700 border-t-2 lg:border-l-4 lg:border-t-4 lg:col-start-2 lg:row-start-2 lg:row-span-1 lg:col-span-1 pt-2 lg:pt-4 pl-2 lg:pl-4 lg:mr-48 lg:ml-16">
      ...
      <div class="hidden lg:visible lg:grid lg:grid-cols-2 ">
    <div class="lg:col-span-1 lg:px-1 ">
    </div>
    <div class="h-0 lg:border-l-4 lg:border-blue-700 lg:col-start-2 lg:h-20 lg:col-span-1 lg:pt-4 lg:pl-4 lg:pr-32 lg:ml-16">
    </div>
  </div>
